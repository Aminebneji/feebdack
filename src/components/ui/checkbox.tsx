...
>(({ className, ...props }, ref) => (
    <CheckboxPrimitive.Root
        ...
        className={classNames(
            "peer h-5 w-5 shrink-0 rounded-md border-2 border-zinc-200 ring-offset-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 data-[state=checked]:bg-primary data-[state=checked]:text-white data-[state=checked]:border-primary transition-all duration-200 ease-in-out cursor-pointer",
            className
        )}
        {...props}
    >
